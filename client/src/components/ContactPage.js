...
#contact-page .logo{font-family:'Montserrat',sans-serif;font-weight:800;font-size:2rem;color:var(--teal);letter-spacing:-.02em}
...
const ASSETS = {
  navLogo: "/microsite/images/mentesquare-logo.png",
  loaderLogo: "/microsite/images/logo.png",
  footerLogo: "/microsite/images/mentesquare-final.png",
};
...
export default function ContactPage() {
  ...
  // Load the Syne/Inter fonts used by the microsite
  useEffect(() => {
    ...
    <div id="contact-page" ref={sectionRef}>
      ...
      <nav className="nav" id="nav">
        <div className="container nav-inner">
          <a href="/microsite/site.html" className="logo" style={{ display: "flex", alignItems: "center", gap: 10 }}>
            <img
              src={ASSETS.navLogo}
          ...
          <div className={`nav-links${navOpen ? " open" : ""}`} id="navLinks">
            <a href="/microsite/site.html#who" onClick={closeNav}>About</a>
            <a href="/microsite/site.html#curriculum" onClick={closeNav}>Curriculum</a>
            <a href="/microsite/site.html#trainers" onClick={closeNav}>Trainers</a>
            <a href="/microsite/site.html#pricing" onClick={closeNav}>Pricing</a>
            <a href="/microsite/site.html#faq" onClick={closeNav}>FAQs</a>
          ...
          <div className="contact-grid">
            ...
            <div className="info-stack reveal">
              ...
              <div className="info-card">
                ...
                <div>
                  <h4>Phone</h4>
                  <a href="tel:+917406173180">+91 7406173180</a>
                </div>
              </div>
              <div className="info-card">
                <div className="info-icon">🔗</div>
              ...
              <div className="faq-nudge">
                Have a quick question? Check our <a href="/microsite/site.html#faq">FAQs</a> — you might find the answer instantly.
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container">
          <div className="foot-grid">
            ...
            <div className="foot-col">
              <h5>Programme</h5>
              <ul>
                <li><a href="/microsite/site.html#who">About</a></li>
                <li><a href="/microsite/site.html#curriculum">Curriculum</a></li>
                <li><a href="/microsite/site.html#pricing">Pricing</a></li>
                <li><a href="/microsite/site.html#reserve-seat">Enroll</a></li>
              </ul>
            </div>
            <div className="foot-col">
              <h5>Company</h5>
              <ul>
                <li><a href="/home" target="_blank" rel="noopener">About</a></li>
                <li><a href="/microsite/site.html#trainers">Faculty</a></li>
            ...
            <div className="foot-col">
              <h5>Support</h5>
              <ul>
                <li><a href="/microsite/site.html#faq">FAQs</a></li>
                <li><a href="/contact">Contact</a></li>
                <li><a href="/microsite/site.html#reserve-seat">Register</a></li>
              </ul>
            </div>
          </div>
